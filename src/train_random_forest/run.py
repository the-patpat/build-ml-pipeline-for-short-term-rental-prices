...
def go(args):
    ...
    model_output_dir = 'random_forest_dir'

    logger.info('Saving random forest model under %s', model_output_dir)
    ...
    artifact = wandb.Artifact(
        ...
        type='model',
        description='Random forest model trained on trainval split'
    )

    artifact.add_dir('random_forest_dir')

    logger.info('Logging inference artifact')
